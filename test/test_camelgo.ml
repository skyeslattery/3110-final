...
let create_test_player = create_player ()

let tests =
  "test suite"
  >::: [
         ( "check collision normal" >:: fun _ -> let p1 = create_test_player in 
